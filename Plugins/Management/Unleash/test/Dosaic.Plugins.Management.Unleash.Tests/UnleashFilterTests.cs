...
namespace Dosaic.Plugins.Management.Unleash.Tests
{
    ...
    public class UnleashFilterTests
    {
        ...
        {
            using var metricsCollector = new TestMetricsCollector(UnleashFilter.UnleashPluginUnleashFilterCallsTotal);
            ...
            metricsCollector.Instruments.Should().Contain(UnleashFilter.UnleashPluginUnleashFilterCallsTotal);
