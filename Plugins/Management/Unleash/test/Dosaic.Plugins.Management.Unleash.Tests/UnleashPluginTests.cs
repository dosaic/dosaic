...
namespace Dosaic.Plugins.Management.Unleash.Tests
{
    ...
    public class UnleashPluginTests
    {
        ...
        {
            using var metricsCollector = new TestMetricsCollector(UnleashPlugin.UnleashPluginImpressionsTotal);
            ...
            metricsCollector.Instruments.Should().Contain(UnleashPlugin.UnleashPluginImpressionsTotal);
        ...
        {
            using var metricsCollector = new TestMetricsCollector(UnleashPlugin.UnleashPluginErrorsTotal);
            metricsCollector.CollectedMetrics.Should().BeEmpty();
            ...
            metricsCollector.Instruments.Should().Contain(UnleashPlugin.UnleashPluginErrorsTotal);
            metricsCollector.CollectedMetrics.Should().ContainsMetric(1);
        }
