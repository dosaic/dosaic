...
namespace Dosaic.Testing.NUnit.Extensions
{
    public static class ObjectExtensions
    {
        public static T GetInaccessibleValue<T>(this object obj, string name)
        {
            ...
            {
                var field = type.GetField(name, BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static);
                if (field is not null)
                    return (T)field.GetValue(obj)!;
                var property = type.GetProperty(name, BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static);
