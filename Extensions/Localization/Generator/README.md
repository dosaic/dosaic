...
- **Configurable default culture** — `EntityLabels.DefaultCulture` can be set at runtime; defaults to `Locale.En`
...
3. **Source emission** — `RegisterSourceOutput` collects all results and emits `EntityLabels.g.cs` into the compilation
